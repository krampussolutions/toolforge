...
export const metadata = { title: "All Tools", description: "Browse all free online tools on UtilHubX, including calculators, converters, image tools, PDF tools, and utilities." };
