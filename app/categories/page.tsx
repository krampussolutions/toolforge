...
export const metadata = { title: "Tool Categories | UtilHubX", description: "Browse tool categories on UtilHubX to explore grouped browser-based workflows and utilities." };
